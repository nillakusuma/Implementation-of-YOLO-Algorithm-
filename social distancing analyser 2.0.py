...
thresh = 0.5
# vname=""
vname=input("Video name in videos folder: video ")
if(vname==""):
    vname="video.mp4"
vid_path = "Documents/Social-Distancing-Analyser-COVID-19-master/videos/"+vname
angle_factor = 0.8
H_zoom_factor = 1.2
...
labelsPath = "Documents\coco.names"
LABELS = open(labelsPath).read().strip().split("\n")

np.random.seed(42)

weightsPath = "Documents/Social-Distancing-Analyser-COVID-19-master/yolov3.weights"
configPath = "Documents/Social-Distancing-Analyser-COVID-19-master/yolov3.cfg"
